package test.kononov.handling.validator;
...
public class FileValidatorTest{
	...
	private static final String EMPTY_FILE_NAME = "data/emptyFile.txt";
	private static final String FAKE_FILE_NAME = "wrong/path/mainText.txt";
